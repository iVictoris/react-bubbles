...
- [x] Explain what a token is used for.
      Auth, send it to server to authenticate user.
- [x] What steps can you take in your web apps to keep your data secure?
      Use JWT / sessions and authN/authZ, verify user entered data
- [x] Describe how web servers work.
      computer/software somewhere in the world sending files to another computer (client);
